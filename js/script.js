...
setInterval(() => {
  if (installmentInput1.value === '106') {
    installmentResult.innerText =
      Math.round((installmentInput2.value * 0.1) / 1200 / (1 - (1 + 0.1 / 1200) ** -6)) + ' BYN';
    ...
    installmentResult.innerText =
      Math.round(
        installmentInput2.value / (24 - 1) + ((installmentInput2.value * 0.146) / 365) * 30.5,
      ) + ' BYN';
    ...
    installmentResult.innerText =
      Math.round(
        installmentInput2.value / (36 - 1) + ((installmentInput2.value * 0.146) / 365) * 30.5,
      ) + ' BYN';
    ...
    installmentResult.innerText =
      Math.round(
        installmentInput2.value / (48 - 1) + ((installmentInput2.value * 0.146) / 365) * 30.5,
      ) + ' BYN';
    ...
    installmentResult.innerText =
      Math.round(
        installmentInput2.value / (60 - 1) + ((installmentInput2.value * 0.146) / 365) * 30.5,
      ) + ' BYN';
  }
}, 500);
/*
